...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_filename.setGeometry(QtCore.QRect(300, 20, 661, 41))
        ...
        self.tabWidget.setGeometry(QtCore.QRect(40, 70, 791, 421))
